...
**Status:** Not started · **Depends on:** phase 1 (envelope), phase 2 + 2.5 (regenerated backlog), phase 3 (`$token` term) · **Blocks:** phase 5's gradient-bypass removal
...
- [ ] Nested Mix types added by the family gain the runtime skew guard
      (extending phase 2's styler-root guard) `[review X5]`.
- [ ] New list-valued wire fields get an explicit lenient-removal granule and a
