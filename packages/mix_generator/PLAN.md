...
- Any symbols referenced by the generated Styler (mixins, mix types, widgets, animation/modifier types). If `mix.dart` does not export a symbol, the stub must import it explicitly.
