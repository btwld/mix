...
void main() {
  group('OpacityModifier', () {
    group('Constructor', () {
      test('assigns opacity correctly', () {
        const opacity = 0.5;
        const modifier = OpacityModifier(opacity: opacity);
    ...
    group('copyWith', () {
      test('returns new instance with updated opacity', () {
        const original = OpacityModifier(opacity: 0.5);
    ...
    group('lerp', () {
      test('interpolates opacity correctly', () {
        const start = OpacityModifier(opacity: 0.0);
        const end = OpacityModifier(opacity: 1.0);
      ...
      test('handles null other parameter', () {
        const start = OpacityModifier(opacity: 0.5);
    ...
    group('equality and hashCode', () {
      test('equal when opacity values match', () {
        const modifier1 = OpacityModifier(opacity: 0.5);
        const modifier2 = OpacityModifier(opacity: 0.5);
      ...
      test('not equal when opacity differs', () {
        const modifier1 = OpacityModifier(opacity: 0.5);
        const modifier2 = OpacityModifier(opacity: 0.8);
    ...
    group('props', () {
      test('contains opacity value', () {
        const modifier = OpacityModifier(opacity: 0.5);
  ...
  group('OpacityModifierMix', () {
    group('Constructor', () {
      test('creates with null opacity by default', () {
        final attribute = OpacityModifierMix();
      ...
      test('creates with provided Prop opacity value', () {
        ...
        final attribute = OpacityModifierMix.create(opacity: opacity);
    ...
    group('only constructor', () {
      test('creates Prop value from direct opacity', () {
        final attribute = OpacityModifierMix(opacity: 0.7);
    ...
    group('resolve', () {
      test('resolves to OpacityModifier with resolved opacity', () {
        ...
        const expectedModifier = OpacityModifier(opacity: 0.7);
    ...
    group('merge', () {
      test('merges with other OpacityModifierMix', () {
        final attribute1 = OpacityModifierMix(opacity: 0.5);
        final attribute2 = OpacityModifierMix(opacity: 0.8);
      ...
      test('merges with null opacity', () {
        final attribute1 = OpacityModifierMix();
        final attribute2 = OpacityModifierMix(opacity: 0.7);
    ...
    group('equality and props', () {
      test('equal when opacity values match', () {
        final attribute1 = OpacityModifierMix(opacity: 0.5);
        final attribute2 = OpacityModifierMix(opacity: 0.5);
  ...
  group('Integration tests', () {
    testWidgets('OpacityModifierMix resolves and builds correctly', (
      WidgetTester tester,
    ) async {
      final attribute = OpacityModifierMix(opacity: 0.3);
    ...
    test('Complex merge scenario preserves and overrides correctly', () {
      final base = OpacityModifierMix(opacity: 0.5);
      final override1 = OpacityModifierMix(opacity: 0.8);
      final override2 = OpacityModifierMix(opacity: 0.2);
