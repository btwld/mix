        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final outlinedResult = outlinedStyler.styleBuilder(BoxStyler(), {
                outlined,
                ...activeVariants,
              }, context);
              final solidResult = solidStyler.styleBuilder(BoxStyler(), {
                solid,
                ...activeVariants,
              }, context);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final outlinedResult = outlinedStyler.styleBuilder(userStyle, {
                outlined,
                small,
              }, context);
        ...
        MaterialApp(
          home: Builder(
            builder: (context) {
              ...
              final result = outlinedStyler.styleBuilder(userModifications, {
                outlined,
                small,
                primary,
              }, context);
