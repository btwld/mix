  ...
  group('VariantSpecAttribute', () {
    group('Constructor', () {
      ...
      test('creates VariantSpecAttribute with ContextVariant', () {
        ...
        final style = BoxStyle(constraints: BoxConstraintsMix.height(200.0));
        final variantAttr = VariantStyle(variant, style);
      ...
      test('creates VariantSpecAttribute with ContextVariant', () {
        final variant = ContextVariant.widgetState(WidgetState.hovered);
        final style = BoxStyle(constraints: BoxConstraintsMix.width(150.0));
        final variantAttr = VariantStyle(variant, style);
    ...
    group('merge method', () {
      test('merges styles when variants match', () {
        const variant = NamedVariant('primary');
        final style1 = BoxStyle(constraints: BoxConstraintsMix.width(100.0));
        final style2 = BoxStyle(constraints: BoxConstraintsMix.height(200.0));
      ...
      test('merges with overlapping properties - other takes precedence', () {
        ...
        final style2 = BoxStyle(constraints: BoxConstraintsMix.width(200.0));
