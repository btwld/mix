...
void main() {
  ...
  group('TextSpecUtility fluent', () {
    test('fluent behavior', () {
      ...
      expect(valueStyle?.color, const Mix<Color>.value(Colors.blue));
      ...
      expect(valueStyle2?.color, const Mix<Color>.value(Colors.blue));
    ...
    test('Mutate behavior and not on same utility', () {
      ...
      expect(valueStyle?.color, const Mix<Color>.value(Colors.red));
      expect(textAttribute.textAlign, TextAlign.center);
