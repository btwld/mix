...
void main() {
  ...
  group('ShadowUtility', () {
    ...
    test('call() returns correct instance', () {
      ...
      expect(shadow.value.blurRadius, resolvesTo(10.0));
      expect(shadow.value.color, isA<Prop<Color>>());
      expect(shadow.value.offset, resolvesTo(const Offset(10, 10)));
    });
  ...
  group('BoxShadowUtility', () {
    ...
    test('call() returns correct instance', () {
      ...
      expect(boxShadow.value.blurRadius, resolvesTo(10.0));
      expect(boxShadow.value.color, isA<Prop<Color>>());
      expect(boxShadow.value.offset, resolvesTo(const Offset(10, 10)));
      expect(boxShadow.value.spreadRadius, resolvesTo(10.0));
    });
    ...
    test('spreadRadius() returns correct instance', () {
      ...
      expect(boxShadow.value.spreadRadius, resolvesTo(10));
    });
    ...
    test('blurRadius() returns correct instance', () {
      ...
      expect(boxShadow.value.blurRadius, resolvesTo(10));
    });
  });
}
