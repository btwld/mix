  ...
  group('Shape Border Utilities', () {
    group('ShapeBorderUtility', () {
      ...
      group('Nested Utilities', () {
        test('roundedRectangle provides access to RoundedRectangleBorderUtility', () {
        ...
        test('continuous provides access to ContinuousRectangleBorderUtility', () {
    ...
    group('RoundedRectangleBorderUtility', () {
      ...
      test('as() creates RoundedRectangleBorderMix from RoundedRectangleBorder', () {
      ...
      group('Property Utilities', () {
        test('borderRadius() creates rounded rectangle border with border radius', () {
        ...
        test('borderRadius.circular() creates rounded rectangle border with circular radius', () {
          final attr = utility.borderRadius.circular(12.0);
          expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
        });

        test('borderRadius.topLeft() creates rounded rectangle border with top left radius', () {
          final attr = utility.borderRadius.topLeft.circular(8.0);
          expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
        });

        test('side() creates rounded rectangle border with side', () {
          final borderSideMix = BorderSideMix.only(color: Colors.green, width: 3.0);
          final attr = utility.side(borderSideMix);
          expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
        });

        test('side.color() creates rounded rectangle border with side color', () {
          final attr = utility.side.color(Colors.purple);
          expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
        });

        test('side.width() creates rounded rectangle border with side width', () {
          final attr = utility.side.width(2.5);
          expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
        });

        test('side.style() creates rounded rectangle border with side style', () {
      ...
      test('token() creates rounded rectangle border from token', () {
        const token = MixToken<RoundedRectangleBorder>('test.roundedRectangleBorder');
        final attr = utility.token(token);
        expect(attr.value, isA<MixProp<RoundedRectangleBorder>>());
      });
    });
    ...
    group('CircleBorderUtility', () {
      ...
      group('Property Utilities', () {
        ...
        test('eccentricity.zero() creates circle border with zero eccentricity', () {
          final attr = utility.eccentricity.zero();
          expect(attr.value, isA<MixProp<CircleBorder>>());
        });

        test('eccentricity.infinity() creates circle border with infinite eccentricity', () {
    ...
    group('BeveledRectangleBorderUtility', () {
      ...
      test('as() creates BeveledRectangleBorderMix from BeveledRectangleBorder', () {
      ...
      group('Property Utilities', () {
        test('borderRadius() creates beveled rectangle border with border radius', () {
          final borderRadiusMix = BorderRadiusMix.only(
        ...
        test('borderRadius.circular() creates beveled rectangle border with circular radius', () {
        ...
        test('side.color() creates beveled rectangle border with side color', () {
      ...
      test('token() creates beveled rectangle border from token', () {
        const token = MixToken<BeveledRectangleBorder>('test.beveledRectangleBorder');
        final attr = utility.token(token);
        expect(attr.value, isA<MixProp<BeveledRectangleBorder>>());
      });
    });
    ...
    group('ContinuousRectangleBorderUtility', () {
      final utility = ContinuousRectangleBorderUtility(UtilityTestAttribute.new);
      ...
      test('as() creates ContinuousRectangleBorderMix from ContinuousRectangleBorder', () {
      ...
      group('Property Utilities', () {
        test('borderRadius() creates continuous rectangle border with border radius', () {
          final borderRadiusMix = BorderRadiusMix.only(
        ...
        test('borderRadius.circular() creates continuous rectangle border with circular radius', () {
        ...
        test('side.color() creates continuous rectangle border with side color', () {
      ...
      test('token() creates continuous rectangle border from token', () {
        const token = MixToken<ContinuousRectangleBorder>('test.continuousRectangleBorder');
        final attr = utility.token(token);
        expect(attr.value, isA<MixProp<ContinuousRectangleBorder>>());
      });
    });
