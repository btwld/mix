  ...
  group('Color Utilities', () {
    group('ColorUtility', () {
      ...
      test('call() creates color from value', () {
        ...
        expect(attr.value, resolvesTo<Color>(Colors.red));
      });
