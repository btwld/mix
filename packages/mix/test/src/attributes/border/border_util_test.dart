...
void main() {
  group('BorderUtility', () {
    ...
    test('border.top()', () {
      ...
      expect(result.value.top?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.top?.color, Mix.value(Colors.yellow));
    ...
    test('border.bottom()', () {
      ...
      expect(result.value.bottom?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.bottom?.color, Mix.value(Colors.yellow));
    ...
    test('border.left()', () {
      ...
      expect(result.value.left?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.left?.color, Mix.value(Colors.yellow));
    ...
    test('border.right()', () {
      ...
      expect(result.value.right?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.right?.color, Mix.value(Colors.yellow));
    ...
    test('border.horizontal()', () {
      ...
      expect(result.value.top?.color, Mix.value(Colors.blue));
      expect(result.value.top?.width, 5.0);
      expect(result.value.top?.style, BorderStyle.solid);
      expect(result.value.top?.strokeAlign, 0.3);
      expect(result.value.bottom?.color, Mix.value(Colors.blue));
    ...
    test('border.vertical()', () {
      ...
      expect(result.value.left?.color, Mix.value(Colors.green));
      expect(result.value.left?.width, 7.0);
      expect(result.value.left?.style, BorderStyle.solid);
      expect(result.value.left?.strokeAlign, 0.2);
      expect(result.value.right?.color, Mix.value(Colors.green));
  ...
  group('BorderDirectionalUtility', () {
    ...
    test('borderDirectional.start()', () {
      ...
      expect(result.value.start?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.start?.color, Mix.value(Colors.yellow));
    ...
    test('borderDirectional.end()', () {
      ...
      expect(result.value.end?.color, Mix.value(Colors.red));
      ...
      expect(resultColor.value.end?.color, Mix.value(Colors.yellow));
    ...
    test('borderDirectional.vertical()', () {
      ...
      expect(result.value.start?.color, Mix.value(Colors.green));
      expect(result.value.start?.width, 7.0);
      expect(result.value.start?.style, BorderStyle.solid);
      expect(result.value.start?.strokeAlign, 0.2);
      expect(result.value.end?.color, Mix.value(Colors.green));
    ...
    test('borderDirectional.all()', () {
      ...
      expect(result.value.bottom?.style, BorderStyle.solid);
      expect(result.value.bottom?.strokeAlign, 0.1);
      expect(result.value.start?.color, Mix.value(Colors.purple));
      expect(result.value.start?.width, 3.0);
      expect(result.value.start?.style, BorderStyle.solid);
      expect(result.value.start?.strokeAlign, 0.1);
      expect(result.value.end?.color, Mix.value(Colors.purple));
