...
final materialTokens = {
    ...
    _md.textTheme.displayMedium.defineBuilder(
      (c) => c.textTheme.displayMedium!,
    ),
    _md.textTheme.displaySmall.defineBuilder((c) => c.textTheme.displaySmall!),
    _md.textTheme.headlineLarge.defineBuilder(
      (c) => c.textTheme.headlineLarge!,
    ),
    _md.textTheme.headlineMedium.defineBuilder(
      (c) => c.textTheme.headlineMedium!,
    ),
    _md.textTheme.headlineSmall.defineBuilder(
      (c) => c.textTheme.headlineSmall!,
    ),
