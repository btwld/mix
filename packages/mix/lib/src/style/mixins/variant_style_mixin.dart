...
mixin VariantStyleMixin<T extends Style<S>, S extends Spec<S>> on Style<S> {
  ...
  T onDark(T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.brightness(Brightness.dark), style),
    ]);
  }

  T onNot(ContextTrigger variantTrigger, T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.not(variantTrigger), style),
    ]);
  }
  ...
  T onLight(T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.brightness(Brightness.light), style),
    ]);
  }
  ...
  T onBreakpoint(Breakpoint breakpoint, T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.breakpoint(breakpoint), style),
    ]);
  }
  ...
  T onMobile(T style) {
    return withVariants([EventVariantStyle<S>(ContextTrigger.mobile(), style)]);
  }

  /// Creates a variant for tablet breakpoint
  T onTablet(T style) {
    return withVariants([EventVariantStyle<S>(ContextTrigger.tablet(), style)]);
  }

  /// Creates a variant for desktop breakpoint
  T onDesktop(T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.desktop(), style),
    ]);
  }
  ...
  T onIos(T style) {
    return withVariants([
      EventVariantStyle<S>(ContextTrigger.platform(TargetPlatform.iOS), style),
    ]);
  }
  ...
  T onWeb(T style) {
    return withVariants([EventVariantStyle<S>(ContextTrigger.web(), style)]);
  }
}
