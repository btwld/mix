...
abstract class StyleElement<S extends Spec<S>> with EqualityMixin {
  // Instance fields
  ...
  @protected
  List<StyleElement<S>> getMatchingContextVariants(BuildContext context) {
  ...
  StyleElement<S> withNamedVariants(Set<NamedVariant> appliedVariants) {
