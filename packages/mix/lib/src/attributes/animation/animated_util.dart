...
final class AnimatedUtility<T extends StyleElement>
  ...
  AnimatedUtility(super.builder)
    : super(
        valueToDto: (value) => AnimationConfigDto(
  ...
  @override
  T only({Duration? duration, Curve? curve, VoidCallback? onEnd}) {
    return builder(
      AnimationConfigDto(duration: duration, curve: curve, onEnd: onEnd),
    );
  }
}
