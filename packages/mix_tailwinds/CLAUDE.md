...
- `lib/src/translate/` — candidate → Mix payload translation, accumulators, routing, and presets
...
- `lib/src/translate/tw_translator.dart` — maps parsed candidates into Mix schema payloads
...
- `lib/src/translate/tw_routing.dart` — early classification for ignored, unsupported, gradient, and schema-routed tokens
