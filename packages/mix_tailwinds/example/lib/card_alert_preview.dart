...
class CardAlertPreview extends StatelessWidget {
  const CardAlertPreview({super.key, this.cardOnly = false});

  /// When true, renders only the card without the gradient background wrapper.
  /// Used for screenshot comparison with `.rounded-3xl` selector.
  final bool cardOnly;
          ...
          Div(
            ...
            children: [
              ...
              Div(
                ...
                child: Div(
                  classNames: 'flex items-center gap-2 text-amber-300 text-sm',
                  children: const [
                    Span(text: '\u26A0'),
