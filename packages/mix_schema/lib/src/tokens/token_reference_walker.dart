...
/// A token reference used by a decoded Mix schema style document.
///
/// [kind] matches the theme document group name (`colors`, `spaces`, etc.).
/// [name] is the token name within that group.
final class MixSchemaTokenReference {
  const MixSchemaTokenReference(this.kind, this.name);

  factory MixSchemaTokenReference.fromToken(MixToken<dynamic> token) {
    return MixSchemaTokenReference(_kindForToken(token), token.name);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is MixSchemaTokenReference &&
            other.kind == kind &&
            other.name == name;
  }
  ...
  @override
  String toString() => 'MixSchemaTokenReference($kind, $name)';
}

/// Returns the unique theme token references used by a decoded Mix style.
Set<MixSchemaTokenReference> tokenReferencesOf(Object? style) {
...
final class _TokenReferenceWalker {
  final Set<MixSchemaTokenReference> references = {};
  ...
  void _addToken(MixToken<dynamic> token) {
    references.add(MixSchemaTokenReference.fromToken(token));
  }
