...
description: "Use variants to style widgets based on state, platform, and context."
---
...
- [Design Tokens](/documentation/guides/design-token) — token-based theming with `MixScope`
- [Pressable](/documentation/widgets/pressable) — interaction state handling for widgets
