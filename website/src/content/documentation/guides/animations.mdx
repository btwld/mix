...
// Hover: color and scale animate to blue and 1.5.
```
...
final style = BoxStyler()
    ...
    .borderRounded(40)
    .phaseAnimation(
      trigger: _isExpanded, // if you want to make it loop, just remove this line
          ...
          timeline: [
            ...
            KeyframeTrack<double>(
              ...
              [
                ...
                .linear(50, 100.ms),
                .elasticOut(20, 500.ms),
                .elasticOut(30, 300.ms),
              ],
              initial: 40,
...
<FlutterPreview previewId="anim-keyframe-toggle" height={200} />
