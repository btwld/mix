...
Mix gives you three ways to bring motion into your UI, depending on how much control you want. You'll see implicit transitions, phase-based sequences, and keyframe timelines in the previews below.
