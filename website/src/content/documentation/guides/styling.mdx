...
final visual = BoxStyler().color(Colors.blue).shadowOnly(blurRadius: 10);
...
- [Utility-First Approach](/documentation/overview/utility-first) — the philosophy behind composable stylers
- [Dynamic Styling](/documentation/guides/dynamic-styling) — variants for hover, press, dark mode, and breakpoints
- [Design Tokens](/documentation/guides/design-token) — centralized values with `MixScope`
- [Widget Modifiers](/documentation/guides/widget-modifiers) — widget-level effects like opacity and clipping via `.wrap()`
