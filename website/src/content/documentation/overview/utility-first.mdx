...
BoxStyler().paddingOnly(left: 12, top: 8);
```
...
BoxStyler accentBorder(Color color) =>
    BoxStyler().borderTop(color: color, width: 2);
...
- [Styling Guide](/documentation/guides/styling) — the full Styler and Spec pattern in depth
- [Dynamic Styling](/documentation/guides/dynamic-styling) — variants for hover, dark mode, and breakpoints
