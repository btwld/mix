...
// Spacing helpers
BoxStyler.padding(EdgeInsetsGeometryMix.all(16)); // All sides
BoxStyler.padding(EdgeInsetsGeometryMix.symmetric(horizontal: 12, vertical: 8)); // Horizontal and vertical
BoxStyler.padding(.only(left: 12, right: 12, top: 8, bottom: 8)); // Specific sides
```
