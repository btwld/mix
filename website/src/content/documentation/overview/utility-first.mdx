...
description: "Understand Mix’s utility-first styling model and composable Styler patterns."
---
...
- **Declarative Semantics** — meaningful, readable styling for widgets.
...
// Spacing helpers
BoxStyler().padding(.all(16)); // All sides
BoxStyler().padding(.symmetric(horizontal: 12, vertical: 8)); // Horizontal and vertical
