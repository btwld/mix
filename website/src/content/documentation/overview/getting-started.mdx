...
- **Dart SDK**: 3.11.0 or higher (required for the fluent Styler API)
- **Flutter**: Latest stable version recommended

<Callout type="info">
  Mix 2.0 uses Dart's enhanced method chaining capabilities introduced in Dart 3.11. Ensure your project's `pubspec.yaml` specifies the correct SDK constraint: `sdk: '>=3.11.0 <4.0.0'`
</Callout>
