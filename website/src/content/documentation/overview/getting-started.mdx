...
- **Dart SDK**: 3.11.0 or higher (required for the fluent Styler API and dot-shorthand syntax)
- **Flutter**: 3.41.0 or higher

<Callout type="info">
  Mix 2.0 uses Dart's dot-shorthand syntax introduced in Dart 3.11. Ensure your project's `pubspec.yaml` specifies the correct SDK constraint: `sdk: '>=3.11.0 <4.0.0'`
</Callout>
