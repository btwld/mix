...
Mix is a styling system for Flutter that separates style definitions from widget structure. It provides a composable, type-safe way to define and apply styles. You'll learn how to define styles with Stylers, apply them to widgets, and adapt them with variants and tokens.
...
The preview below shows this style applied to a box.

<FlutterPreview previewId="box-basic" height={200} />
