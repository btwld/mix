...
class CustomButtonStyle {
  ...
  BoxStyler container() => BoxStyler()
      .borderRounded(8)
      .variant(
        CustomButtonSize.medium,
        BoxStyler().paddingX(16).paddingY(8),
      )
      .variant(
        CustomButtonSize.large,
        BoxStyler().paddingX(24).paddingY(16),
      )
      .variant(
      ...
      .variant(
        ...
        BoxStyler().color(Colors.redAccent),
      )
      .variant(
