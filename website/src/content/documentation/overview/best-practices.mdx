...
This example utilizes Mix's styled widgets: `Pressable`, `Box`, and `StyledText`. Explore the full list of styled widgets [here](/documentation/widgets/stylewidgets).
...
class CustomButtonStyle {
  ...
  BoxStyler container() {
    var style = BoxStyler.borderRadius(BorderRadiusMix.circular(8));
...
<FlutterPreview previewId="variant-hover" title="CustomButton-style interaction" height={220} />

The preview below shows hover and press states similar to what your CustomButton will exhibit when you add variants to its style.
