---
title: Pressable
description: "Handle press, hover, focus, and disabled interaction states for Mix widgets."
---
...
<Callout type="info">
When `mouseCursor` is null, `Pressable` chooses `SystemMouseCursors.click` when enabled and `SystemMouseCursors.forbidden` when disabled.
</Callout>
...
- [Dynamic Styling](/documentation/guides/dynamic-styling) — variant system for hover, press, focus, and more
- [Box](/documentation/widgets/box) — `BoxStyler` API used with `PressableBox`
