---
title: "StyledText"
description: "Style Flutter text with TextStyler — font size, weight, color, decorations, text directives, and responsive variants in Mix."
---
...
- [Design Tokens](/documentation/guides/design-token) — `TextStyleToken` for reusable typography
