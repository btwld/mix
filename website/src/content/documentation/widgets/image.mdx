---
title: "StyledImage"
description: "Style Flutter images with ImageStyler — dimensions, color blend modes, fit, filters, and responsive variants in Mix."
---
...
- [Box](/documentation/widgets/box) — container styling with `BoxStyler`
