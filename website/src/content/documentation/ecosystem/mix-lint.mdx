...
**Prefer:** A `const MyStyler.create({ … })` plus a forwarding `MyStyler(...)` if you need convenience. See the [mix_generator](/documentation/ecosystem/mix-generator) page and existing Stylers under `packages/mix` for full patterns.

## Related docs

- [mix_generator](/documentation/ecosystem/mix-generator) — annotations and generated Styler/Spec/Mix mixins
- [Styling guide](/documentation/guides/styling) — Styler, Spec, and widgets
- [Design tokens](/documentation/guides/design-token) — `MixScope` and tokens
