...
description: "Build a reusable button component with Mix specs, stylers, and variants."
---

# Building a Design System Widget

**Prerequisites:** Familiarity with [Styling with Mix](/documentation/guides/styling) and [Dynamic Styling](/documentation/guides/dynamic-styling).
...
![Four button variants: filled, outline, elevated, and link styles](./images/button-example.png)

## Component Overview

### Button Variants

![Button variants showing filled, outline, elevated, and link styles side by side](./images/button-variants.png)
...
![Button states showing normal, hover, pressed, and disabled appearances](./images/button-states.png)
...
class ButtonStyler extends MixStyler<ButtonStyler, ButtonSpec>
  ...
  ButtonStyler({
    ...
    super.modifier,
    super.variants,
  }) : // Prop.maybeMix wraps optional Styler values for the resolution pipeline
...
enum ButtonVariant {
  ...
  ButtonStyler get style => switch (this) {
    ButtonVariant.filled => ButtonStyler()
        .backgroundColor(Colors.blueAccent)
        .textColor(Colors.white)
        .iconColor(Colors.white),

    ButtonVariant.outlined => ButtonStyler()
        .container(
          FlexBoxStyler()
    ...
    ButtonVariant.elevated => ButtonStyler()
        .backgroundColor(Colors.blueAccent)
        .textColor(Colors.white)
        .iconColor(Colors.white)
        .container(
          FlexBoxStyler().shadow(
            // BoxShadowMix is Mix's fluent builder for BoxShadow
            BoxShadowMix()
    ...
    ButtonVariant.link => ButtonStyler()
        .container(
          FlexBoxStyler()
  ...
  return ButtonStyler()
      ...
      .onDisabled(
        ButtonStyler()
            ...
            .label(TextStyler().color(Colors.blueGrey.shade700))
...
![Demo app showing all button variants and a disabled button](./images/button-demo.png)
