---
title: "Theming"
description: "Build and apply token-driven Mix themes with MixScope."
---

# Theming

**Prerequisites:** Familiarity with [Styling with Mix](/documentation/guides/styling) and [Design Tokens](/documentation/guides/design-token).
...
![Side-by-side comparison of light blue and dark purple themed profile screens](./images/two-themed-app.png)
...
![Profile screen with light blue theme applied](./images/light-themed-app.png)
