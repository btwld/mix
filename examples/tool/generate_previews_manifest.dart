...
const _rootRegistryPath = 'examples/lib/preview_registry.dart';

void main(List<String> args) {
  final outputPath = _readOutputPath(args) ?? _defaultOutputPath;
  final registryFile = _resolveRegistryFile().absolute;
  final examplesDir = registryFile.parent.parent;
  final projectRoot = examplesDir.parent.path;
...
File _resolveRegistryFile() {
  ...
  final root = File(_rootRegistryPath);
  if (root.existsSync()) {
    return root;
  }
