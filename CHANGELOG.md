...
Packages with other changes:
 ...
 - [`mix` - `v1.7.0-beta.1`](#mix---v170-beta1)
 - [`mix_annotations` - `v1.7.0-beta.1`](#mix_annotations---v170-beta1)
 - [`mix_generator` - `v1.7.0-beta.1`](#mix_generator---v170-beta1)
 - [`mix_lint` - `v1.7.0-beta.1`](#mix_lint---v170-beta1)
...
#### `mix` - `v1.7.0-beta.1`
 ...
 - **REFACTOR**: Rename MenuItem to ListItem component (#688).
 ...
 - **FIX**: Remove focused style utility classes from specs for v1.7.0 (#701).
